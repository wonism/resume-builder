...
const FormComponent = () => {
  ...
  return (
    <>
      ...
      <Box d={['block', 'flex']} alignItems={['initial', 'start']} w="100%" color="black" bg="white">
        <Formik
          initialValues={data}
          onSubmit={(values) => {
        ...
        />
        <Box ref={resumeRef} mt={[4, 0]} px={4} pb={4} flex={['initial', 1]} h={['auto', 'calc(100vh - 9.75rem)']} overflowY="auto">
          {resume != null ? (
            <>
